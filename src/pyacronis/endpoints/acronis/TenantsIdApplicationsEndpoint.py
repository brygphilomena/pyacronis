...
class TenantsIdApplicationsEndpoint(
    AcronisEndpoint,
):
    """Represents the /tenants/{tenant_id}/applications endpoint of the Acronis Account Management API."""
    ...
    def get(
        ...
        """
        Performs a GET request against the /tenants/{tenant_id}/applications endpoint.
