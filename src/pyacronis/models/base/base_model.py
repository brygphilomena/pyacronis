...
from pyacronis.utils.naming import to_camel_case


class AcronisModel(BaseModel):
    ...
    def _get_field_names(cls) -> list[str]:
        ...
        for v in cls.__fields__.values():
            ...
            for arg in get_args(v.annotation):
                if inspect.isclass(arg) and issubclass(arg, AcronisModel):
                    was_model = True
    ...
    def _get_field_names_and_types(cls) -> dict[str, str]:  # noqa: C901
        ...
        for v in cls.__fields__.values():
            ...
            if get_origin(v.annotation) is UnionType or get_origin(v.annotation) is Union:
                ...
                if inspect.isclass(v.annotation) and issubclass(v.annotation, AcronisModel):
                    was_model = True
